package honorVipOnline_box_fla
{
    ...
    dynamic public class confirm_CreateRoom_Uselect_box_35 extends MovieClip
    {
        ...
        public function confirm_CreateRoom_Uselect_box_35()
        {
        ...
        public function list(param1:uint = 0) : Boolean
        {
            ...
            while (_loc_2 < len)
            {
                ...
                _loc_3 = new select_confirm_CreateRoom_data_mc();
        ...
        {
            _selectData = dataArr[param1];
            selected_btn.select_txt.text = labelArr[param1];
            return;
        }// end function
        ...
        public function selectClickHandler(event:MouseEvent) : void
        {
            ...
            {
                select_list.scorll_mc.setToTop();
