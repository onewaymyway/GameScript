package uas
{
    ...
    public class SelectRadioBox extends EventDispatcher
    {
        ...
        public function SelectRadioBox()
        {
        ...
        public function def() : void
        {
            ...
            while (_loc_1 < this.Arrboxs.length)
            {
                ...
                if (_loc_1 == this._defIndex)
                {
                    this.selectedMc = this.Arrboxs[_loc_1];
                    this._selectData = this.ArrboxsVo[_loc_1];
                    this.Arrboxs[_loc_1].gotoAndPlay(3);
                }
                else
                {
                    this.Arrboxs[_loc_1].gotoAndStop(1);
                }
                _loc_1 = _loc_1 + 1;
            }
            return;
        ...
        public function SetBoxs(param1:Array, param2:Array, param3:int) : void
        {
        ...
        public function addBoxs(param1:Array, param2:Array, param3:int) : void
        {
            var _loc_5:MovieClip = null;
            var _loc_4:uint = 0;
            while (_loc_4 < param1.length)
        ...
        public function selectIndex(param1:uint) : void
        {
            this.selectedMc = null;
            var _loc_2:uint = 0;
        ...
        public function selectByValue(param1:Object) : void
        {
            this.selectedMc = null;
            var _loc_2:uint = 0;
            while (_loc_2 < this.Arrboxs.length)
            {
                ...
                if (this.ArrboxsVo[_loc_2] == param1)
                {
                    this.selectedMc = this.Arrboxs[_loc_2];
                    this._selectData = this.ArrboxsVo[_loc_2];
                    this.Arrboxs[_loc_2].gotoAndPlay(3);
