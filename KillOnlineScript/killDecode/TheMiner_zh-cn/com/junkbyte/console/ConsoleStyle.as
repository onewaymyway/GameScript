package com.junkbyte.console
{
    ...
    public class ConsoleStyle extends Object
    {
        ...
        {
            this._css.setStyle("high", {color:this.hesh(this.highColor), fontFamily:this.menuFont, fontSize:this.menuFontSize, display:"inline"});
            this._css.setStyle("low", {color:this.hesh(this.lowColor), fontFamily:this.menuFont, fontSize:this.menuFontSize - 2, display:"inline"});
            this._css.setStyle("menu", {color:this.hesh(this.menuColor), display:"inline"});
            this._css.setStyle("menuHi", {color:this.hesh(this.menuHighlightColor), display:"inline"});
            this._css.setStyle("chs", {color:this.hesh(this.channelsColor), fontSize:this.menuFontSize, leading:"2", display:"inline"});
            this._css.setStyle("ch", {color:this.hesh(this.channelColor), display:"inline"});
            this._css.setStyle("tt", {color:this.hesh(this.menuColor), fontFamily:this.menuFont, fontSize:this.menuFontSize, textAlign:"center"});
            this._css.setStyle("r", {textAlign:"right", display:"inline"});
            this._css.setStyle("p", {fontFamily:this.traceFont, fontSize:this.traceFontSize});
            this._css.setStyle("p0", {color:this.hesh(this.priority0), display:"inline"});
            this._css.setStyle("p1", {color:this.hesh(this.priority1), display:"inline"});
            this._css.setStyle("p2", {color:this.hesh(this.priority2), display:"inline"});
            this._css.setStyle("p3", {color:this.hesh(this.priority3), display:"inline"});
            this._css.setStyle("p4", {color:this.hesh(this.priority4), display:"inline"});
            this._css.setStyle("p5", {color:this.hesh(this.priority5), display:"inline"});
            this._css.setStyle("p6", {color:this.hesh(this.priority6), display:"inline"});
            this._css.setStyle("p7", {color:this.hesh(this.priority7), display:"inline"});
            this._css.setStyle("p8", {color:this.hesh(this.priority8), display:"inline"});
            this._css.setStyle("p9", {color:this.hesh(this.priority9), display:"inline"});
            this._css.setStyle("p10", {color:this.hesh(this.priority10), fontWeight:"bold", display:"inline"});
            this._css.setStyle("p-1", {color:this.hesh(this.priorityC1), display:"inline"});
            this._css.setStyle("p-2", {color:this.hesh(this.priorityC2), display:"inline"});
            this._css.setStyle("logs", {color:this.hesh(this.logHeaderColor), display:"inline"});
            this._css.setStyle("type", {fontFamily:this.traceTypedFont, fontSize:(this.traceFontSize + 1), display:"inline"});
            return;
        }// end function
