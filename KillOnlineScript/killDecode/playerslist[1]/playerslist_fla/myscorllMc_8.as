package playerslist_fla
{
    import flash.display.*;
    import flash.events.*;
    import flash.utils.*;

    dynamic public class myscorllMc_8 extends MovieClip
    {
        ...
        {
            var _loc_2:* = undefined;
            _loc_2 = param1.currentTarget.name;
            if (_loc_2 == "up_btn")
            {
                act = "up";
                setObjY(delta);
        ...
        public function setMidY()
        {
            ...
            markHH = Objmark.height;
            _loc_1 = ObjHH - markHH;
            _loc_2 = (-Obj.y + Objmark.y) * scH / _loc_1 + upBtn_H;
            if (_loc_1 > 0)
            {
                if (_loc_2 < upBtn_H)
                {
        ...
        {
            Obj.graphics.clear();
            Obj.graphics.beginFill(6710886, 0);
