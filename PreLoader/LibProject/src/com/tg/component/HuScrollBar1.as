...

{
	...
	/**
		双向(横板+竖版)滚动条
		Hdz All rights reserved.
	*/
	public class HuScrollBar1
	{
		...
		{
			_scale9Grid = $value ;
			try { _scrollBar.scale9Grid =  _scale9Grid } catch (e:Error) { _scrollBar.scale9Grid = null }
		}
		...
		*
		* @param		$scrollIcon		        Sprite		      			 * 滚动块图标
		* @param		$Btn1		            Sprite		      			 * 向上 / 向左 按钮
		* @param		$Btn2	        		Sprite		      			 * 向下 / 向右 按钮
		* 
		* 
		...
		*/  
		public function HuScrollBar1($target:DisplayObjectContainer, $maskTarget:*, $scrollBar:Sprite, $scrollLine:Sprite, $scrollIcon:Sprite , $Btn1:SimpleButton , $Btn2:SimpleButton ,$tween:Number = 5, $elastic:Boolean = false, $lineAbleClick:Boolean = false , $mouseWheel:Boolean = false, $direction:String = "L") 
		{
